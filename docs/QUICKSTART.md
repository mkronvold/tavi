...
| `KUBERNETES.md` | Choosing among the four Kubernetes deployment variants and operating them | No              |
...
1. `WORKSPACE.md` for daily project and task review.
2. `SETTINGS.md` for browser-local preferences, account-specific settings, and admin controls.
3. `IMPORT_EXPORT.md` for the settings-launched import/export panel.
4. `BACKUPS.md` for the settings-launched backup and restore panel.
5. `NOTIFICATIONS.md` for project/task update emails and daily digest behavior.
