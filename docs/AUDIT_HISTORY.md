...
| Email delivery history | `Settings`, then `Audit emails` |
...
4. `Audit emails` is admin-only and focuses on outbound delivery state rather than entity change history.
